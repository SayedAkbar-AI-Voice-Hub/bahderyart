  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="fixed bottom-6 left-6 z-[200] bg-black text-white text-[10px] px-5 py-3 uppercase tracking-widest hover:scale-105 active:scale-95 transition-all rounded-full border border-white/20 shadow-2xl flex items-center gap-2 font-bold"
      >
        <span className="text-lg leading-none">⚙</span> Website Setup
      </button>
    );
  }
